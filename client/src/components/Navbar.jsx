    ...
    return (
        <div className="navbar w-full h-[60px] flex items-center justify-between bg-transparent px-10">
            ...
            <div className="right flex items-center justify-center gap-5">
                ...
                <button onClick={() => navigate("/history")} className="font-semibold text-black text-sm hover:text-blue-600 transition-all hover:scale-110 cursor-pointer">History</button>
